...
auto StringUtil::StartsWith(const std::string &str,
                            const std::string &prefix) -> bool {
  return std::equal(prefix.begin(), prefix.end(), str.begin());
}

auto StringUtil::EndsWith(const std::string &str,
...
auto StringUtil::Repeat(const std::string &str,
...
auto StringUtil::Split(const std::string &str,
...
auto StringUtil::Prefix(const std::string &str,
...
auto StringUtil::Split(const std::string &input,
                       const std::string &split) -> std::vector<std::string> {
