...
auto IntegerType::Subtract(const Value &left,
...
auto IntegerType::Multiply(const Value &left,
                           const Value &right) const -> Value {
  assert(left.CheckInteger());
  assert(left.CheckComparable(right));
  if (left.IsNull() || right.IsNull()) {
...
auto IntegerType::CompareEquals(const Value &left,
...
auto IntegerType::CompareNotEquals(const Value &left,
                                   const Value &right) const -> CmpBool {
  assert(left.CheckInteger());
  assert(left.CheckComparable(right));
  if (left.IsNull() || right.IsNull()) {
...
auto IntegerType::CompareLessThan(const Value &left,
                                  const Value &right) const -> CmpBool {
  assert(left.CheckInteger());
  assert(left.CheckComparable(right));
  if (left.IsNull() || right.IsNull()) {
...
auto IntegerType::CompareGreaterThanEquals(
...
auto IntegerType::CastAs(const Value &val,
